<nav id="navbar">
    ...
    <ul id="navMain" class="nav__main">
        ...
        <li>
            <ul>
                <li>
                    <a aria-label="{{ __('locales.selectedLang') }} {{ __(App\Enums\Locale::getFullLanguageName(app()->getLocale())) }}"
                        href="/{{ app()->getLocale() }}">{{ app()->getLocale() }}</a>
