    ...
    public function run(): void
    {
        ...
        $projects = Project::factory()->createMany([
            [
                ...
                "github_url" => "https://github.com/SvenCazier/metube_front",
            ],
            [
                ...
                "image" => "jim",
                "live_url" => "http://localhost/jim/",
                "github_url" => "https://github.com/SvenCazier/jim",
            ],
            [
                ...
                "image" => "caesar",
                "live_url" => "",
                "github_url" => "https://github.com/SvenCazier/caesar_code",
            ],
            [
                ...
                "image" => "schattenjager",
                "live_url" => "",
                "github_url" => "https://github.com/SvenCazier/schattenjager",
            ],
            [
                ...
                "image" => "pizza",
                "live_url" => "",
                "github_url" => "https://github.com/SvenCazier/php_adv_test",
            ],
            [
                ...
                "image" => "scrum",
                "live_url" => "",
                "github_url" => "https://github.com/SvenCazier/scrum",
            ]
        ]);
